...
class Concat_ATT(nn.Module):
    def __init__(self, channel, dimension=1):
        ...
        self.d = dimension
        self.att = GAM_Attention(channel)
...
class Mlp(nn.Module):
    ...
    def __init__(self, in_features, hidden_features=None, out_features=None, act_layer=FReLU, drop=0.):
        super().__init__()
...
class SwinTransformerLayer(nn.Module):
    ...
    def __init__(self, dim, num_heads, window_size=8, shift_size=0,
                 ...
                 act_layer=FReLU, norm_layer=nn.LayerNorm):
        super().__init__()
        self.dim = dim
        self.num_heads = num_heads
...
class SwinTransformerLayer_v2(nn.Module):
    ...
    def __init__(self, dim, num_heads, window_size=7, shift_size=0,
                 ...
                 act_layer=FReLU, norm_layer=nn.LayerNorm, pretrained_window_size=0):
        super().__init__()
        self.dim = dim
